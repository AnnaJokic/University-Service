...
class Student(models.Model):
    ...
    slika = models.ImageField(upload_to='media', null=True)
...
class Nastavnik(models.Model):
    ...
    #def __str__(self):
     #   return self.ime + " " + str(self.prezime) + " " + str(self.titula) + " " + self.zvanje + " " + str(self.predmet)+ " " + str(self.nalog)
...
class Termin(models.Model):
    ...
    def __str__(self):
        return self.oznaka_ucionice + " " + str(self.pocetak) + " " + str(self.zavrsetak) + " " + self.tip_nastave + " " + str(self.predmet)+" "+str(self.dan)
...
class TerminPolaganja(models.Model):
    ...
    predmet = models.ForeignKey(Predmet, on_delete=models.DO_NOTHING)
    #nastavnik = models.ForeignKey(Nastavnik, on_delete=models.DO_NOTHING)
    nastavnik = models.ManyToManyField(Nastavnik)
